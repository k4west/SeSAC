    ...
    <div className="p-4 w-3/4 m-auto">
      ...
      <div className="border border-gray-200 rounded-lg p-8">
        <div className="text-center mb-4">
          <img
            src={`https://picsum.photos/300/200?random=${Math.floor(Math.random() * 100)}`}
            alt="Developer"
            className="inline-block rounded-full w-64 h-64"
          />
          <h3 className="text-xl font-semibold mt-2">세비</h3>
          <p>LLM 개발자 </p>
        </div>
        <div className="mb-4">
          <h4 className="text-lg font-semibold">개발자 소개</h4>
          <p>저는 세비 개발자 입니다. 만나서 반가워요.</p>
        </div>
        <div className="mb-4">
        ...
        <div>
          ...
          <p>Email: kwestmin@gmail.com</p>
          <p>LinkedIn: www.linkedin.com/in/joesavvy</p>
        </div>
      </div>
    </div>
  );
