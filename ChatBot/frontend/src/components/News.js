...
const newsData = [
  {
    ...
    img: `https://picsum.photos/300/200?random=${Math.floor(Math.random() * 100)}`,
  },
  {
    id: 2,
    title: "웹 크롤링 정복",
...
function News() {
  return (
    <div className="p-4 w-2/3 m-auto">
      <h2 className="text-2xl font-bold mb-4">세비의 근황</h2>
      <div>
        {newsData.map((newsItem) => (
          ...
          >
            <div className="flex flex-col">
              ...
              <a href={`/news/${newsItem.id}`} className="text-blue-600 hover:text-blue-800 mt-4">
                Read more
              </a>
            </div>
